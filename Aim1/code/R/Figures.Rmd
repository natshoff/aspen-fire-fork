...
arr4 <- ggarrange(f4a,f4b,widths=c(1, 0.85), align="h")
arr4
ggsave(arr4, file = "../../figures/Figure4_ModelSel_BestModel.png",
       dpi = 300, bg="white") # adjust dpi accordingly
```
...
f7 <- ggplot(data=aggr.sr.m, aes(x=factor(blocksize), y=value, fill=factor(source))) +
  ...
  # geom_point(data=aggr.wr.m, aes(x=factor(blocksize), y=value)) +
...
#   geom_point(data=aggr.wr.m, aes(x=factor(blocksize), y=value, shape=region), 
